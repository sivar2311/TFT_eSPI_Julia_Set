...
#define TFT_CS   4  // Chip select control pin (library pulls permanently low
#define TFT_DC   5  // Data Command control pin - must use a pin in the range 0-31
#define TFT_RST  3  // Reset pin, toggles on startup

#define TFT_WR    6  // Write strobe control pin - must use a pin in the range 0-31
#define TFT_RD    7  // Read strobe control pin

#define TFT_D0   8  // Must use pins in the range 0-31 for the data bus
#define TFT_D1   9  // so a single register write sets/clears all bits.
#define TFT_D2   10  // Pins can be randomly assigned, this does not affect
#define TFT_D3   11  // TFT screen update performance.
#define TFT_D4   12
#define TFT_D5   13
#define TFT_D6   14
#define TFT_D7   15
